...
// Send reset email
exports.sendPasswordResetEmail = async (to, firstName, lastName, resetLink) => {
    const mailOptions = {
        from: '"Phoenixopia Solutions" <process.env.USER_1>',
        to: to,
        ...
        html: `
            <html>
                <body style="font-family: Arial, sans-serif; color: #555; line-height: 1.6;">
                    ...
                    <p style="margin-left: 40px; margin-bottom: 30px;">
                        <a href="${resetLink}" style="font-size: 16px; color: #1a73e8; text-decoration: none; font-weight: bold;">Confirm Email Address</a>
                    </p>
                    <p style="font-size: 16px; margin-bottom: 30px;">
                        If you did not sign up for this account, please disregard this email.
                    </p>
